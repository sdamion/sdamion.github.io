(function () {
    ...
    const GOVERNANCE_CATALYST_CHARTS_SCRIPT_SRC = 'governance-catalyst-charts.js?v=20260817-modular-catalyst-charts-2';
    ...
    const GOVERNANCE_SCRIPT_SRC = 'governance.js?v=20260817-modular-catalyst-charts-2';
