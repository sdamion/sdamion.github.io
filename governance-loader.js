(function () {
    ...
    const GOVERNANCE_CATALYST_FORMAT_SCRIPT_SRC = 'governance-catalyst-format.js?v=20260817-modular-catalyst-format-3';
    ...
    const GOVERNANCE_SCRIPT_SRC = 'governance.js?v=20260817-modular-catalyst-format-4';
