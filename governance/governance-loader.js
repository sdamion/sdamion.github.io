(function () {
    ...
    const GOVERNANCE_ASSISTANT_SCRIPT_SRC = 'governance/governance-assistant.js?v=20260904-constitution-context';
    ...
    const GOVERNANCE_SCRIPT_SRC = 'governance/governance.js?v=20260902-retired-multipool-color';
