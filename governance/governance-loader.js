(function () {
    ...
    const GOVERNANCE_API_SCRIPT_SRC = 'governance/governance-api.js?v=20260829-pilot-2026-visible';
    ...
    const GOVERNANCE_SCRIPT_SRC = 'governance/governance.js?v=20260831-retired-stake-delegators';
