...
export type Snapshot={infos:AddressInfo[];txs:Tx[];facts:Record<string,Fact>;markets:Record<string,Market>;adaUsd:number|null;history:Record<string,number>;updated:string;complete:boolean;priceAt:string|null;groups?:Record<string,string[]>;swapGroups?:Record<string,string[]>;pendingOwnershipAddresses?:string[]};
