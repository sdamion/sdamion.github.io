...
import {normalizeCexAddresses,cexDestinations,cexAdjustedFact} from './cex.ts';
...
const exchanges=normalizeCexAddresses([{address:a,name:' Exchange A '},{address:b,name:'Exchange B'},{address:b,name:'Exchange B'},{address:stake,name:'Invalid'}]);
...
assert.deepEqual(outbound.externalOutputs,[{address:b,lovelace:'8000000'}]);
