...
export type Fact = { hash:string; time:number; adaRaw:string; assets:Record<string,string>; decimals:Record<string,number>; feeRaw:string|null; internal:boolean; wallets:string[]; swapCandidate:boolean; counterpartyVersion?:number; externalOutputs?:Counterparty[]; externalInputs?:Counterparty[]; minted?:Record<string,string>; inputRefs?:string[]; ownedInputCount?:number; marketplaceVersion?:number; marketplacePurchases?:Record<string,MarketplacePurchase> };
