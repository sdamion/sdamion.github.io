const DASHBOARD_API_URL = 'https://www.thedutchstakepool.com/api/dashboard';
const COMPACT_DASHBOARD_API_URL = 'https://www.thedutchstakepool.com/api/dashboard/compact';
const COMMITTEE_INFO_API_URL = 'https://www.thedutchstakepool.com/api/committee/directory';
const COMMITTEE_MEMBER_API_BASE_URL = 'https://www.thedutchstakepool.com/api/committee/member';
const PROPOSAL_VOTES_API_BASE_URL = 'https://www.thedutchstakepool.com/api/proposal';
const PROPOSAL_DETAIL_API_BASE_URL = 'https://www.thedutchstakepool.com/api/proposal';
const PROPOSAL_SUMMARY_API_BASE_URL = 'https://www.thedutchstakepool.com/api/proposal';
const DREP_INFO_API_URL = 'https://www.thedutchstakepool.com/api/dreps/directory';
const DREP_DETAIL_API_BASE_URL = 'https://www.thedutchstakepool.com/api/drep';
const SPO_DIRECTORY_API_URL = 'https://www.thedutchstakepool.com/api/spos/directory';
const SPO_DETAIL_API_BASE_URL = 'https://www.thedutchstakepool.com/api/spo';
const REMOTE_METADATA_API_URL = 'https://www.thedutchstakepool.com/api/metadata';
const TREASURY_API_URL = 'https://www.thedutchstakepool.com/api/treasury';
const CATALYST_BUSINESS_API_URL = 'https://www.thedutchstakepool.com/api/catalyst/businesses';
const CATALYST_PROPOSALS_API_URL = 'https://www.thedutchstakepool.com/api/catalyst/proposals';
const CATALYST_PROPOSAL_DETAIL_API_BASE_URL = 'https://www.thedutchstakepool.com/api/catalyst/proposal';
const CATALYST_PROPOSAL_SUMMARY_API_BASE_URL = 'https://www.thedutchstakepool.com/api/catalyst/proposal';
const CONSTITUTION_CHAT_API_URL = 'https://www.thedutchstakepool.com/api/constitution/chat';
const CONSTITUTION_CHAT_FEEDBACK_API_URL = 'https://www.thedutchstakepool.com/api/constitution/chat/feedback';
const CONSTITUTION_DOCUMENT_API_URL = 'https://www.thedutchstakepool.com/api/constitution/document';
...
const TREASURY_BUSINESS_LOGOS = Object.freeze({
    ...
    'Orion Fund / Arouet Holdings': 'https://www.draperdragon.com/favicon.ico',
