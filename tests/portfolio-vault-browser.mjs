...
try{
  ...
  await page.route('**/*',async route=>{
    ...
    return route.fulfill({contentType:'text/html',body:'<!doctype html><link rel="stylesheet" href="/styles.css"><title>Vault test</title><main class="member-portfolio"><div id="progress"></div></main>'});
  });
  ...
  for(const width of [1280,390]){
    ...
    const bar=await page.getByRole('progressbar').boundingBox();assert.ok(bar.width>150&&bar.x+bar.width<=width);
